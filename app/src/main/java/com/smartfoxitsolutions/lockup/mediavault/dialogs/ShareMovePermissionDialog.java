...
/**
 * Created by RAAJA on 28-12-2016.
 */

public class ShareMovePermissionDialog extends DialogFragment {
    ...
    public void onStart() {
        ...
        final MediaMoveActivity activity = (MediaMoveActivity) getActivity();
