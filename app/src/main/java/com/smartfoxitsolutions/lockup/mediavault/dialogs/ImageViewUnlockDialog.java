...
import com.smartfoxitsolutions.lockup.mediavault.VaultImageViewActivity;

/**
 * Created by RAAJA on 03-12-2016.
 */

public class ImageViewUnlockDialog extends DialogFragment {
    ...
    public void onStart() {
        ...
        final VaultImageViewActivity activity = (VaultImageViewActivity) getActivity();
