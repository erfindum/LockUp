...
public class LockPinViewFinger extends FrameLayout implements View.OnClickListener{
    ...
    public LockPinViewFinger(Context context, OnPinLockUnlockListener pinLockListener,boolean isFingerPrintActive) {
        super(context);
    ...
    void initializeLockView(){
        ...
        pinLockAdView = (NativeExpressAdView) findViewById(R.id.pin_lock_activity_finger_ad_view);
